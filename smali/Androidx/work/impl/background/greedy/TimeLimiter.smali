...
.method public final cancel(Landroidx/work/impl/StartStopToken;)V
    ...
    .line 42
    .local v1, "$i$a$-let-TimeLimiter$cancel$2":I
    iget-object v2, p0, Landroidx/work/impl/background/greedy/TimeLimiter;->runnableScheduler:Landroidx/work/RunnableScheduler;

    invoke-interface {v2, v0}, Landroidx/work/RunnableScheduler;->cancel(Ljava/lang/Runnable;)V

    .line 43
    .end local v0    # "it":Ljava/lang/Runnable;
    .end local v1    # "$i$a$-let-TimeLimiter$cancel$2":I
    :cond_0
    return-void
