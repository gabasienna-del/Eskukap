...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/WorkerParameters;)V
    ...
    iput-object v0, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->lock:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->future:Landroidx/work/impl/utils/futures/SettableFuture;
...
.method private final setupAndRunConstraintTrackingWork()V
    ...
    .line 73
    .local v1, "logger":Landroidx/work/Logger;
    move-object v2, v0
    ...
    .line 75
    iget-object v2, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->future:Landroidx/work/impl/utils/futures/SettableFuture;

    const-string v3, "future"

    invoke-static {v2, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v2}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setFailed(Landroidx/work/impl/utils/futures/SettableFuture;)Z
    ...
    .line 89
    .local v2, "workManagerImpl":Landroidx/work/impl/WorkManagerImpl;
    ...
    .line 91
    iget-object v4, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->future:Landroidx/work/impl/utils/futures/SettableFuture;

    const-string v5, "future"

    invoke-static {v4, v5}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v4}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setFailed(Landroidx/work/impl/utils/futures/SettableFuture;)Z
    ...
    invoke-interface {v5}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()Lkotlinx/coroutines/CoroutineDispatcher;
    ...
    .line 98
    .local v5, "dispatcher":Lkotlinx/coroutines/CoroutineDispatcher;
    move-object v6, p0

    check-cast v6, Landroidx/work/impl/constraints/OnConstraintsStateChangedListener;

    invoke-static {v4, v3, v5, v6}, Landroidx/work/impl/constraints/WorkConstraintsTrackerKt;->listen(Landroidx/work/impl/constraints/WorkConstraintsTracker;Landroidx/work/impl/model/WorkSpec;Lkotlinx/coroutines/CoroutineDispatcher;Landroidx/work/impl/constraints/OnConstraintsStateChangedListener;)Lkotlinx/coroutines/Job;

    move-result-object v6

    .line 99
    .local v6, "job":Lkotlinx/coroutines/Job;
    iget-object v7, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->future:Landroidx/work/impl/utils/futures/SettableFuture;

    new-instance v8, Landroidx/work/impl/workers/ConstraintTrackingWorker$$ExternalSyntheticLambda1;

    invoke-direct {v8, v6}, Landroidx/work/impl/workers/ConstraintTrackingWorker$$ExternalSyntheticLambda1;-><init>(Lkotlinx/coroutines/Job;)V

    new-instance v9, Landroidx/work/impl/utils/SynchronousExecutor;

    invoke-direct {v9}, Landroidx/work/impl/utils/SynchronousExecutor;-><init>()V

    check-cast v9, Ljava/util/concurrent/Executor;

    invoke-virtual {v7, v8, v9}, Landroidx/work/impl/utils/futures/SettableFuture;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual {v1, v7, v8}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 107
    :try_start_0
    iget-object v7, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->delegate:Landroidx/work/ListenableWorker;
    ...
    .line 108
    .local v7, "innerFuture":Lcom/google/common/util/concurrent/ListenableFuture;
    new-instance v8, Landroidx/work/impl/workers/ConstraintTrackingWorker$$ExternalSyntheticLambda2;

    invoke-direct {v8, p0, v7}, Landroidx/work/impl/workers/ConstraintTrackingWorker$$ExternalSyntheticLambda2;-><init>(Landroidx/work/impl/workers/ConstraintTrackingWorker;Lcom/google/common/util/concurrent/ListenableFuture;)V
    ...
    .end local v7    # "innerFuture":Lcom/google/common/util/concurrent/ListenableFuture;
    goto/16 :goto_3
    ...
    const-string v10, "Delegated worker "
    ...
    const-string v10, " threw exception in startWork."
    ...
    .line 118
    invoke-virtual {v1, v8, v9, v7}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 121
    iget-object v8, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->lock:Ljava/lang/Object;
    ...
    .line 122
    .local v9, "$i$a$-synchronized-ConstraintTrackingWorker$setupAndRunConstraintTrackingWork$3":I
    :try_start_1
    iget-boolean v10, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->areConstraintsUnmet:Z
    ...
    const-string v11, "Constraints were unmet, Retrying."

    invoke-virtual {v1, v10, v11}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;)V

    .line 124
    iget-object v10, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->future:Landroidx/work/impl/utils/futures/SettableFuture;

    const-string v11, "future"

    invoke-static {v10, v11}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v10}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setRetry(Landroidx/work/impl/utils/futures/SettableFuture;)Z
    ...
    invoke-static {v10}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setFailed(Landroidx/work/impl/utils/futures/SettableFuture;)Z
    :try_end_1
    ...
    .line 121
    .end local v9    # "$i$a$-synchronized-ConstraintTrackingWorker$setupAndRunConstraintTrackingWork$3":I
    monitor-exit v8
    ...
    const-string v9, "Constraints not met for delegate "
    ...
    const-string v9, ". Requesting retry."
    ...
    invoke-static {v7}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setRetry(Landroidx/work/impl/utils/futures/SettableFuture;)Z
...
.method private static final setupAndRunConstraintTrackingWork$lambda$3(Landroidx/work/impl/workers/ConstraintTrackingWorker;Lcom/google/common/util/concurrent/ListenableFuture;)V
    .locals 4
    .param p0, "this$0"    # Landroidx/work/impl/workers/ConstraintTrackingWorker;
    .param p1, "$innerFuture"    # Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 110
    .local v1, "$i$a$-synchronized-ConstraintTrackingWorker$setupAndRunConstraintTrackingWork$2$1":I
    :try_start_0
    ...
    invoke-static {v2}, Landroidx/work/impl/workers/ConstraintTrackingWorkerKt;->access$setRetry(Landroidx/work/impl/utils/futures/SettableFuture;)Z
    ...
    invoke-virtual {v2, p1}, Landroidx/work/impl/utils/futures/SettableFuture;->setFuture(Lcom/google/common/util/concurrent/ListenableFuture;)Z

    .line 115
    :goto_0
    nop

    .end local v1    # "$i$a$-synchronized-ConstraintTrackingWorker$setupAndRunConstraintTrackingWork$2$1":I
...
.method public onConstraintsStateChanged(Landroidx/work/impl/model/WorkSpec;Landroidx/work/impl/constraints/ConstraintsState;)V
    ...
    .line 152
    .local v1, "$i$a$-synchronized-ConstraintTrackingWorker$onConstraintsStateChanged$1":I
    const/4 v2, 0x1

    :try_start_0
    iput-boolean v2, p0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->areConstraintsUnmet:Z

    .end local v1    # "$i$a$-synchronized-ConstraintTrackingWorker$onConstraintsStateChanged$1":I
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onStopped()V
    ...
    .line 141
    .local v0, "delegateInner":Landroidx/work/ListenableWorker;
    if-eqz v0, :cond_1
